...
#ifndef __RRCConnectionReject_H__
#define __RRCConnectionReject_H__
...
{
public:
    RRCConnectionReject() : criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_c1_Enum {
        k_criticalExtensions_c1_rrcConnectionReject_r8 = 0,
...
public:
    RRCConnectionReject_r8_IEs* criticalExtensions_c1_rrcConnectionReject_r8_Set();
    int criticalExtensions_c1_rrcConnectionReject_r8_Set(RRCConnectionReject_r8_IEs &value);
    const RRCConnectionReject_r8_IEs& criticalExtensions_c1_rrcConnectionReject_r8_Get() const;
    std::string criticalExtensions_c1_rrcConnectionReject_r8_ToString(uint32_t indent) const;
    std::string criticalExtensions_c1_rrcConnectionReject_r8_ToStringNoNewLines() const;
    int criticalExtensions_c1_rrcConnectionReject_r8_Clear();
    bool criticalExtensions_c1_rrcConnectionReject_r8_IsPresent() const;
private:
    bool criticalExtensions_c1_rrcConnectionReject_r8_present;
    RRCConnectionReject_r8_IEs criticalExtensions_c1_rrcConnectionReject_r8;
