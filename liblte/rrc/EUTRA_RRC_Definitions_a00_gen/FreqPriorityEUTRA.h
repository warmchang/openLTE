...
#ifndef __FreqPriorityEUTRA_H__
#define __FreqPriorityEUTRA_H__
...
class FreqPriorityEUTRA
{
public:
    FreqPriorityEUTRA() : carrierFreq_present{false}, cellReselectionPriority_present{false} {};
public:
