...
#ifndef __RRCConnectionReestablishment_v8a0_IEs_H__
#define __RRCConnectionReestablishment_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class RRCConnectionReestablishment_v8a0_IEs
{
public:
    RRCConnectionReestablishment_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
