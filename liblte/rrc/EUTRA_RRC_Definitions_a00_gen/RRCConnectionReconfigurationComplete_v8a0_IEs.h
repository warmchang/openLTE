...
#ifndef __RRCConnectionReconfigurationComplete_v8a0_IEs_H__
#define __RRCConnectionReconfigurationComplete_v8a0_IEs_H__
...
class RRCConnectionReconfigurationComplete_v8a0_IEs
{
public:
    RRCConnectionReconfigurationComplete_v8a0_IEs() : lateNonCriticalExtension_present{false}, nonCriticalExtension_present{false} {};
public:
...
public:
    RRCConnectionReconfigurationComplete_v10xy_IEs* nonCriticalExtension_Set();
    int nonCriticalExtension_Set(RRCConnectionReconfigurationComplete_v10xy_IEs &value);
    const RRCConnectionReconfigurationComplete_v10xy_IEs& nonCriticalExtension_Get() const;
...
private:
    ...
    RRCConnectionReconfigurationComplete_v10xy_IEs nonCriticalExtension;
