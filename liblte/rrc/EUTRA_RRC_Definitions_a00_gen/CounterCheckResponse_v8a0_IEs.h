...
#ifndef __CounterCheckResponse_v8a0_IEs_H__
#define __CounterCheckResponse_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class CounterCheckResponse_v8a0_IEs
{
public:
    CounterCheckResponse_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
