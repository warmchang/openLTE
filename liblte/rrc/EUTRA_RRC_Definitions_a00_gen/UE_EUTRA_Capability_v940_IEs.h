...
#ifndef __UE_EUTRA_Capability_v940_IEs_H__
#define __UE_EUTRA_Capability_v940_IEs_H__
...
class UE_EUTRA_Capability_v940_IEs
{
public:
    UE_EUTRA_Capability_v940_IEs() : lateNonCriticalExtension_present{false}, nonCriticalExtension_present{false} {};
public:
...
public:
    UE_EUTRA_Capability_v10xy_IEs* nonCriticalExtension_Set();
    int nonCriticalExtension_Set(UE_EUTRA_Capability_v10xy_IEs &value);
    const UE_EUTRA_Capability_v10xy_IEs& nonCriticalExtension_Get() const;
...
private:
    ...
    UE_EUTRA_Capability_v10xy_IEs nonCriticalExtension;
