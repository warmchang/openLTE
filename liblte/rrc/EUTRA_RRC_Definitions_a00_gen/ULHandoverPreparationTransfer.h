...
#ifndef __ULHandoverPreparationTransfer_H__
#define __ULHandoverPreparationTransfer_H__
...
class ULHandoverPreparationTransfer
{
public:
    ULHandoverPreparationTransfer() : criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_c1_Enum {
        k_criticalExtensions_c1_ulHandoverPreparationTransfer_r8 = 0,
...
public:
    ULHandoverPreparationTransfer_r8_IEs* criticalExtensions_c1_ulHandoverPreparationTransfer_r8_Set();
    int criticalExtensions_c1_ulHandoverPreparationTransfer_r8_Set(ULHandoverPreparationTransfer_r8_IEs &value);
    const ULHandoverPreparationTransfer_r8_IEs& criticalExtensions_c1_ulHandoverPreparationTransfer_r8_Get() const;
    std::string criticalExtensions_c1_ulHandoverPreparationTransfer_r8_ToString(uint32_t indent) const;
    std::string criticalExtensions_c1_ulHandoverPreparationTransfer_r8_ToStringNoNewLines() const;
    int criticalExtensions_c1_ulHandoverPreparationTransfer_r8_Clear();
    bool criticalExtensions_c1_ulHandoverPreparationTransfer_r8_IsPresent() const;
private:
    bool criticalExtensions_c1_ulHandoverPreparationTransfer_r8_present;
    ULHandoverPreparationTransfer_r8_IEs criticalExtensions_c1_ulHandoverPreparationTransfer_r8;
