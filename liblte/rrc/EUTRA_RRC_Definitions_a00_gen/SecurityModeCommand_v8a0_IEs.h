...
#ifndef __SecurityModeCommand_v8a0_IEs_H__
#define __SecurityModeCommand_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class SecurityModeCommand_v8a0_IEs
{
public:
    SecurityModeCommand_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
