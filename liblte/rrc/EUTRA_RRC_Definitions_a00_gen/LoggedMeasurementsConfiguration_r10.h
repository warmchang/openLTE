...
#ifndef __LoggedMeasurementsConfiguration_r10_H__
#define __LoggedMeasurementsConfiguration_r10_H__
...
class LoggedMeasurementsConfiguration_r10
{
public:
    LoggedMeasurementsConfiguration_r10() : criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_c1_Enum {
        k_criticalExtensions_c1_loggedMeasurementsConfiguration_r10 = 0,
...
public:
    LoggedMeasurementsConfiguration_r10_IEs* criticalExtensions_c1_loggedMeasurementsConfiguration_r10_Set();
    int criticalExtensions_c1_loggedMeasurementsConfiguration_r10_Set(LoggedMeasurementsConfiguration_r10_IEs &value);
    const LoggedMeasurementsConfiguration_r10_IEs& criticalExtensions_c1_loggedMeasurementsConfiguration_r10_Get() const;
    std::string criticalExtensions_c1_loggedMeasurementsConfiguration_r10_ToString(uint32_t indent) const;
    std::string criticalExtensions_c1_loggedMeasurementsConfiguration_r10_ToStringNoNewLines() const;
    int criticalExtensions_c1_loggedMeasurementsConfiguration_r10_Clear();
    bool criticalExtensions_c1_loggedMeasurementsConfiguration_r10_IsPresent() const;
private:
    bool criticalExtensions_c1_loggedMeasurementsConfiguration_r10_present;
    LoggedMeasurementsConfiguration_r10_IEs criticalExtensions_c1_loggedMeasurementsConfiguration_r10;
