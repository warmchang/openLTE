...
#ifndef __SecurityModeComplete_v8a0_IEs_H__
#define __SecurityModeComplete_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class SecurityModeComplete_v8a0_IEs
{
public:
    SecurityModeComplete_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
