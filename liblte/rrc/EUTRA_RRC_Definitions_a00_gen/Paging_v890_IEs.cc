...
int Paging_v890_IEs::Pack(std::vector<uint8_t> &bits)
{
    // Extension indicator
    ...
    if(lateNonCriticalExtension_IsPresent())
    {
        ...
        {
            printf("Paging_v890_IEs:: field pack failure\n");
            return -1;
        }
    }
...
int Paging_v890_IEs::Unpack(std::vector<uint8_t> bits)
{
    uint32_t idx = 0;
    return Unpack(bits, idx);
}

int Paging_v890_IEs::Unpack(std::vector<uint8_t> bits, uint32_t &idx)
{
    // Extension indicator
    ...
    if((idx + 1) > bits.size())
    {
        printf("Paging_v890_IEs::Unpack() index out of bounds for optional indiator lateNonCriticalExtension\n");
        return -1;
    }
    lateNonCriticalExtension_present = bits[idx++];
    if((idx + 1) > bits.size())
    {
        printf("Paging_v890_IEs::Unpack() index out of bounds for optional indiator nonCriticalExtension\n");
        return -1;
    }
    ...
    if(lateNonCriticalExtension_present)
    {
        ...
        {
            printf("Paging_v890_IEs:: field unpack failure\n");
            return -1;
        }
    }
...
std::string Paging_v890_IEs::ToString(uint32_t indent) const
{
    std::string out;
...
std::string Paging_v890_IEs::ToStringNoNewLines() const
{
    std::string out = "Paging_v890_IEs:";
    if(lateNonCriticalExtension_IsPresent())
...
int Paging_v890_IEs::lateNonCriticalExtension_Pack(std::vector<uint8_t> &bits)
{
...
int Paging_v890_IEs::lateNonCriticalExtension_Unpack(std::vector<uint8_t> bits)
{
    uint32_t idx = 0;
    return lateNonCriticalExtension_Unpack(bits, idx);
}

int Paging_v890_IEs::lateNonCriticalExtension_Unpack(std::vector<uint8_t> bits, uint32_t &idx)
{
    uint32_t local_size_length = 0;
    uint32_t size = 0;
    if(0 == bits[idx++])
    ...
    {
        printf("Paging_v890_IEs::lateNonCriticalExtension_Unpack() index out of bounds\n");
        return -1;
    }
...
std::vector<uint8_t> Paging_v890_IEs::lateNonCriticalExtension_Value() const
{
    if(lateNonCriticalExtension_present)
...
int Paging_v890_IEs::lateNonCriticalExtension_SetValue(std::vector<uint8_t> value)
{
...
std::string Paging_v890_IEs::lateNonCriticalExtension_ToString(uint32_t indent) const
{
    std::string out;
    for(uint32_t i=0; i<indent; i++)
        out += "    ";
...
std::string Paging_v890_IEs::lateNonCriticalExtension_ToStringNoNewLines() const
{
...
int Paging_v890_IEs::lateNonCriticalExtension_Clear()
{
    lateNonCriticalExtension_present = false;
    return 0;
}

bool Paging_v890_IEs::lateNonCriticalExtension_IsPresent() const
{
    return lateNonCriticalExtension_present;
}

Paging_v920_IEs* Paging_v890_IEs::nonCriticalExtension_Set()
{
    nonCriticalExtension_present = true;
    return &nonCriticalExtension;
}

int Paging_v890_IEs::nonCriticalExtension_Set(Paging_v920_IEs &value)
{
    nonCriticalExtension_present = true;
...
const Paging_v920_IEs& Paging_v890_IEs::nonCriticalExtension_Get() const
{
    return nonCriticalExtension;
}

std::string Paging_v890_IEs::nonCriticalExtension_ToString(uint32_t indent) const
{
    std::string out;
    for(uint32_t i=0; i<indent; i++)
        out += "    ";
...
std::string Paging_v890_IEs::nonCriticalExtension_ToStringNoNewLines() const
{
...
int Paging_v890_IEs::nonCriticalExtension_Clear()
{
    nonCriticalExtension_present = false;
    return 0;
}

bool Paging_v890_IEs::nonCriticalExtension_IsPresent() const
{
