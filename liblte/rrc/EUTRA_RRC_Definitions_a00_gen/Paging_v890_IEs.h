...
#ifndef __Paging_v890_IEs_H__
#define __Paging_v890_IEs_H__
...
class Paging_v890_IEs
{
public:
    Paging_v890_IEs() : lateNonCriticalExtension_present{false}, nonCriticalExtension_present{false} {};
public:
...
public:
    Paging_v920_IEs* nonCriticalExtension_Set();
    int nonCriticalExtension_Set(Paging_v920_IEs &value);
    const Paging_v920_IEs& nonCriticalExtension_Get() const;
...
private:
    ...
    Paging_v920_IEs nonCriticalExtension;
