...
#ifndef __RRCConnectionSetupComplete_v8a0_IEs_H__
#define __RRCConnectionSetupComplete_v8a0_IEs_H__
...
class RRCConnectionSetupComplete_v8a0_IEs
{
public:
    RRCConnectionSetupComplete_v8a0_IEs() : lateNonCriticalExtension_present{false}, nonCriticalExtension_present{false} {};
public:
...
public:
    RRCConnectionSetupComplete_v10xy_IEs* nonCriticalExtension_Set();
    int nonCriticalExtension_Set(RRCConnectionSetupComplete_v10xy_IEs &value);
    const RRCConnectionSetupComplete_v10xy_IEs& nonCriticalExtension_Get() const;
...
private:
    ...
    RRCConnectionSetupComplete_v10xy_IEs nonCriticalExtension;
