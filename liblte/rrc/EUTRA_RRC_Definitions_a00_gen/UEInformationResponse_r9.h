...
#ifndef __UEInformationResponse_r9_H__
#define __UEInformationResponse_r9_H__
...
class UEInformationResponse_r9
{
public:
    UEInformationResponse_r9() : rrc_TransactionIdentifier_present{false}, criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_c1_Enum {
        k_criticalExtensions_c1_ueInformationResponse_r9 = 0,
...
public:
    UEInformationResponse_r9_IEs* criticalExtensions_c1_ueInformationResponse_r9_Set();
    int criticalExtensions_c1_ueInformationResponse_r9_Set(UEInformationResponse_r9_IEs &value);
    const UEInformationResponse_r9_IEs& criticalExtensions_c1_ueInformationResponse_r9_Get() const;
    std::string criticalExtensions_c1_ueInformationResponse_r9_ToString(uint32_t indent) const;
    std::string criticalExtensions_c1_ueInformationResponse_r9_ToStringNoNewLines() const;
    int criticalExtensions_c1_ueInformationResponse_r9_Clear();
    bool criticalExtensions_c1_ueInformationResponse_r9_IsPresent() const;
private:
    bool criticalExtensions_c1_ueInformationResponse_r9_present;
    UEInformationResponse_r9_IEs criticalExtensions_c1_ueInformationResponse_r9;
