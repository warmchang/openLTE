...
#ifndef __UECapabilityEnquiry_v8a0_IEs_H__
#define __UECapabilityEnquiry_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class UECapabilityEnquiry_v8a0_IEs
{
public:
    UECapabilityEnquiry_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
