...
#ifndef __UECapabilityInformation_H__
#define __UECapabilityInformation_H__
...
{
public:
    UECapabilityInformation() : rrc_TransactionIdentifier_present{false}, criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_c1_Enum {
        k_criticalExtensions_c1_ueCapabilityInformation_r8 = 0,
...
public:
    UECapabilityInformation_r8_IEs* criticalExtensions_c1_ueCapabilityInformation_r8_Set();
    int criticalExtensions_c1_ueCapabilityInformation_r8_Set(UECapabilityInformation_r8_IEs &value);
    const UECapabilityInformation_r8_IEs& criticalExtensions_c1_ueCapabilityInformation_r8_Get() const;
    std::string criticalExtensions_c1_ueCapabilityInformation_r8_ToString(uint32_t indent) const;
    std::string criticalExtensions_c1_ueCapabilityInformation_r8_ToStringNoNewLines() const;
    int criticalExtensions_c1_ueCapabilityInformation_r8_Clear();
    bool criticalExtensions_c1_ueCapabilityInformation_r8_IsPresent() const;
private:
    bool criticalExtensions_c1_ueCapabilityInformation_r8_present;
    UECapabilityInformation_r8_IEs criticalExtensions_c1_ueCapabilityInformation_r8;
