...
#ifndef __MobilityFromEUTRACommand_H__
#define __MobilityFromEUTRACommand_H__
...
class MobilityFromEUTRACommand
{
public:
    MobilityFromEUTRACommand() : rrc_TransactionIdentifier_present{false}, criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_c1_Enum {
        k_criticalExtensions_c1_mobilityFromEUTRACommand_r8 = 0,
        k_criticalExtensions_c1_mobilityFromEUTRACommand_r9,
...
public:
    MobilityFromEUTRACommand_r8_IEs* criticalExtensions_c1_mobilityFromEUTRACommand_r8_Set();
    int criticalExtensions_c1_mobilityFromEUTRACommand_r8_Set(MobilityFromEUTRACommand_r8_IEs &value);
    const MobilityFromEUTRACommand_r8_IEs& criticalExtensions_c1_mobilityFromEUTRACommand_r8_Get() const;
    std::string criticalExtensions_c1_mobilityFromEUTRACommand_r8_ToString(uint32_t indent) const;
    std::string criticalExtensions_c1_mobilityFromEUTRACommand_r8_ToStringNoNewLines() const;
    int criticalExtensions_c1_mobilityFromEUTRACommand_r8_Clear();
    bool criticalExtensions_c1_mobilityFromEUTRACommand_r8_IsPresent() const;
private:
    bool criticalExtensions_c1_mobilityFromEUTRACommand_r8_present;
    MobilityFromEUTRACommand_r8_IEs criticalExtensions_c1_mobilityFromEUTRACommand_r8;

    // mobilityFromEUTRACommand-r9
public:
    MobilityFromEUTRACommand_r9_IEs* criticalExtensions_c1_mobilityFromEUTRACommand_r9_Set();
    int criticalExtensions_c1_mobilityFromEUTRACommand_r9_Set(MobilityFromEUTRACommand_r9_IEs &value);
    const MobilityFromEUTRACommand_r9_IEs& criticalExtensions_c1_mobilityFromEUTRACommand_r9_Get() const;
    std::string criticalExtensions_c1_mobilityFromEUTRACommand_r9_ToString(uint32_t indent) const;
    std::string criticalExtensions_c1_mobilityFromEUTRACommand_r9_ToStringNoNewLines() const;
    int criticalExtensions_c1_mobilityFromEUTRACommand_r9_Clear();
    bool criticalExtensions_c1_mobilityFromEUTRACommand_r9_IsPresent() const;
private:
    bool criticalExtensions_c1_mobilityFromEUTRACommand_r9_present;
    MobilityFromEUTRACommand_r9_IEs criticalExtensions_c1_mobilityFromEUTRACommand_r9;
