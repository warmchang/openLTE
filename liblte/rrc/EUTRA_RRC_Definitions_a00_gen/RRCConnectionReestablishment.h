...
#ifndef __RRCConnectionReestablishment_H__
#define __RRCConnectionReestablishment_H__
...
class RRCConnectionReestablishment
{
public:
    RRCConnectionReestablishment() : rrc_TransactionIdentifier_present{false}, criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_c1_Enum {
        k_criticalExtensions_c1_rrcConnectionReestablishment_r8 = 0,
...
public:
    RRCConnectionReestablishment_r8_IEs* criticalExtensions_c1_rrcConnectionReestablishment_r8_Set();
    int criticalExtensions_c1_rrcConnectionReestablishment_r8_Set(RRCConnectionReestablishment_r8_IEs &value);
    const RRCConnectionReestablishment_r8_IEs& criticalExtensions_c1_rrcConnectionReestablishment_r8_Get() const;
    std::string criticalExtensions_c1_rrcConnectionReestablishment_r8_ToString(uint32_t indent) const;
    std::string criticalExtensions_c1_rrcConnectionReestablishment_r8_ToStringNoNewLines() const;
    int criticalExtensions_c1_rrcConnectionReestablishment_r8_Clear();
    bool criticalExtensions_c1_rrcConnectionReestablishment_r8_IsPresent() const;
private:
    bool criticalExtensions_c1_rrcConnectionReestablishment_r8_present;
    RRCConnectionReestablishment_r8_IEs criticalExtensions_c1_rrcConnectionReestablishment_r8;
