...
#ifndef __CellsToAddModUTRA_TDD_H__
#define __CellsToAddModUTRA_TDD_H__
...
class CellsToAddModUTRA_TDD
{
public:
    CellsToAddModUTRA_TDD() : cellIndex_present{false}, physCellId_present{false} {};
public:
...
private:
    ...
    // physCellId
public:
    PhysCellIdUTRA_TDD* physCellId_Set();
    int physCellId_Set(PhysCellIdUTRA_TDD &value);
    const PhysCellIdUTRA_TDD& physCellId_Get() const;
