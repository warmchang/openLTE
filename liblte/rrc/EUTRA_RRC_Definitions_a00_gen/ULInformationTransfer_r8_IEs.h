...
#ifndef __ULInformationTransfer_r8_IEs_H__
#define __ULInformationTransfer_r8_IEs_H__
...
class ULInformationTransfer_r8_IEs
{
public:
    ULInformationTransfer_r8_IEs() : dedicatedInfoType_present{false}, nonCriticalExtension_present{false} {};
public:
...
public:
    ULInformationTransfer_v8a0_IEs* nonCriticalExtension_Set();
    int nonCriticalExtension_Set(ULInformationTransfer_v8a0_IEs &value);
    const ULInformationTransfer_v8a0_IEs& nonCriticalExtension_Get() const;
...
private:
    ...
    ULInformationTransfer_v8a0_IEs nonCriticalExtension;
