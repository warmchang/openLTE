...
#ifndef __CSFBParametersRequestCDMA2000_v8a0_IEs_H__
#define __CSFBParametersRequestCDMA2000_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class CSFBParametersRequestCDMA2000_v8a0_IEs
{
public:
    CSFBParametersRequestCDMA2000_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
