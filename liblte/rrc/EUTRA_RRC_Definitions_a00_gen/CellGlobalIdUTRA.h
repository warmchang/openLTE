...
#ifndef __CellGlobalIdUTRA_H__
#define __CellGlobalIdUTRA_H__
...
class CellGlobalIdUTRA
{
public:
    CellGlobalIdUTRA() : plmn_Identity_present{false}, cellIdentity_present{false} {};
public:
...
public:
    ...
    uint32_t cellIdentity_Value() const;
    int cellIdentity_SetValue(uint32_t value);
...
private:
    ...
    uint32_t cellIdentity_internal_value;
