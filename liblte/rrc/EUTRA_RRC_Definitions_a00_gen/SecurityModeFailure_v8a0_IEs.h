...
#ifndef __SecurityModeFailure_v8a0_IEs_H__
#define __SecurityModeFailure_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class SecurityModeFailure_v8a0_IEs
{
public:
    SecurityModeFailure_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
