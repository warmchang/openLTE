...
#ifndef __CounterCheck_v8a0_IEs_H__
#define __CounterCheck_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class CounterCheck_v8a0_IEs
{
public:
    CounterCheck_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
