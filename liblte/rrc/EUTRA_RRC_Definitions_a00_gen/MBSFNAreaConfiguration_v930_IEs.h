...
#ifndef __MBSFNAreaConfiguration_v930_IEs_H__
#define __MBSFNAreaConfiguration_v930_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class MBSFNAreaConfiguration_v930_IEs
{
public:
    MBSFNAreaConfiguration_v930_IEs() : lateNonCriticalExtension_present{false} {};
public:
