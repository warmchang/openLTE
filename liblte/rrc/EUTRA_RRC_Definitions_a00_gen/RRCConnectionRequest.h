...
#ifndef __RRCConnectionRequest_H__
#define __RRCConnectionRequest_H__
...
{
public:
    RRCConnectionRequest() : criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_Enum {
        k_criticalExtensions_rrcConnectionRequest_r8 = 0,
...
public:
    RRCConnectionRequest_r8_IEs* criticalExtensions_rrcConnectionRequest_r8_Set();
    int criticalExtensions_rrcConnectionRequest_r8_Set(RRCConnectionRequest_r8_IEs &value);
    const RRCConnectionRequest_r8_IEs& criticalExtensions_rrcConnectionRequest_r8_Get() const;
    std::string criticalExtensions_rrcConnectionRequest_r8_ToString(uint32_t indent) const;
    std::string criticalExtensions_rrcConnectionRequest_r8_ToStringNoNewLines() const;
    int criticalExtensions_rrcConnectionRequest_r8_Clear();
    bool criticalExtensions_rrcConnectionRequest_r8_IsPresent() const;
private:
    bool criticalExtensions_rrcConnectionRequest_r8_present;
    RRCConnectionRequest_r8_IEs criticalExtensions_rrcConnectionRequest_r8;
