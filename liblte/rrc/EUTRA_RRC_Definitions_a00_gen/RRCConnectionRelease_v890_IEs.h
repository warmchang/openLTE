...
#ifndef __RRCConnectionRelease_v890_IEs_H__
#define __RRCConnectionRelease_v890_IEs_H__
...
class RRCConnectionRelease_v890_IEs
{
public:
    RRCConnectionRelease_v890_IEs() : lateNonCriticalExtension_present{false}, nonCriticalExtension_present{false} {};
public:
...
public:
    RRCConnectionRelease_v920_IEs* nonCriticalExtension_Set();
    int nonCriticalExtension_Set(RRCConnectionRelease_v920_IEs &value);
    const RRCConnectionRelease_v920_IEs& nonCriticalExtension_Get() const;
...
private:
    ...
    RRCConnectionRelease_v920_IEs nonCriticalExtension;
