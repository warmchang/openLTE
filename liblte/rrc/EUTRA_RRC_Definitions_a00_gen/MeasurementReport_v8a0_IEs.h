...
#ifndef __MeasurementReport_v8a0_IEs_H__
#define __MeasurementReport_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class MeasurementReport_v8a0_IEs
{
public:
    MeasurementReport_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
