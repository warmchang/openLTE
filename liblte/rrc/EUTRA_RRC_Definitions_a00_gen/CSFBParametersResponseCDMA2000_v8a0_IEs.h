...
#ifndef __CSFBParametersResponseCDMA2000_v8a0_IEs_H__
#define __CSFBParametersResponseCDMA2000_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class CSFBParametersResponseCDMA2000_v8a0_IEs
{
public:
    CSFBParametersResponseCDMA2000_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
