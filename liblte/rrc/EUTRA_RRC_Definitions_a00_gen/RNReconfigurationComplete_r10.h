...
#ifndef __RNReconfigurationComplete_r10_H__
#define __RNReconfigurationComplete_r10_H__
...
class RNReconfigurationComplete_r10
{
public:
    RNReconfigurationComplete_r10() : rrc_TransactionIdentifier_present{false}, criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_c1_Enum {
        k_criticalExtensions_c1_rnReconfigurationComplete_r10 = 0,
...
public:
    RNReconfigurationComplete_r10_IEs* criticalExtensions_c1_rnReconfigurationComplete_r10_Set();
    int criticalExtensions_c1_rnReconfigurationComplete_r10_Set(RNReconfigurationComplete_r10_IEs &value);
    const RNReconfigurationComplete_r10_IEs& criticalExtensions_c1_rnReconfigurationComplete_r10_Get() const;
    std::string criticalExtensions_c1_rnReconfigurationComplete_r10_ToString(uint32_t indent) const;
    std::string criticalExtensions_c1_rnReconfigurationComplete_r10_ToStringNoNewLines() const;
    int criticalExtensions_c1_rnReconfigurationComplete_r10_Clear();
    bool criticalExtensions_c1_rnReconfigurationComplete_r10_IsPresent() const;
private:
    bool criticalExtensions_c1_rnReconfigurationComplete_r10_present;
    RNReconfigurationComplete_r10_IEs criticalExtensions_c1_rnReconfigurationComplete_r10;
