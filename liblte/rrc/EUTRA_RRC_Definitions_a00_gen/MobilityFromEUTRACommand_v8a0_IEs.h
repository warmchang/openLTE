...
#ifndef __MobilityFromEUTRACommand_v8a0_IEs_H__
#define __MobilityFromEUTRACommand_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class MobilityFromEUTRACommand_v8a0_IEs
{
public:
    MobilityFromEUTRACommand_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
