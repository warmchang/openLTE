...
#ifndef __BandClassPriority1XRTT_H__
#define __BandClassPriority1XRTT_H__
...
class BandClassPriority1XRTT
{
public:
    BandClassPriority1XRTT() : bandClass_present{false}, cellReselectionPriority_present{false} {};
public:
