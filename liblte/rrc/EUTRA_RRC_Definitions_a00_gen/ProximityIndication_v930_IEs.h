...
#ifndef __ProximityIndication_v930_IEs_H__
#define __ProximityIndication_v930_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class ProximityIndication_v930_IEs
{
public:
    ProximityIndication_v930_IEs() : lateNonCriticalExtension_present{false} {};
public:
