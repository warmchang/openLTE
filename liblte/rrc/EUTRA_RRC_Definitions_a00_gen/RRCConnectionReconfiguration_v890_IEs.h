...
#ifndef __RRCConnectionReconfiguration_v890_IEs_H__
#define __RRCConnectionReconfiguration_v890_IEs_H__
...
class RRCConnectionReconfiguration_v890_IEs
{
public:
    RRCConnectionReconfiguration_v890_IEs() : lateNonCriticalExtension_present{false}, nonCriticalExtension_present{false} {};
public:
...
public:
    RRCConnectionReconfiguration_v920_IEs* nonCriticalExtension_Set();
    int nonCriticalExtension_Set(RRCConnectionReconfiguration_v920_IEs &value);
    const RRCConnectionReconfiguration_v920_IEs& nonCriticalExtension_Get() const;
...
private:
    ...
    RRCConnectionReconfiguration_v920_IEs nonCriticalExtension;
