...
#ifndef __RRCConnectionSetup_r8_IEs_H__
#define __RRCConnectionSetup_r8_IEs_H__
...
class RRCConnectionSetup_r8_IEs
{
public:
    RRCConnectionSetup_r8_IEs() : radioResourceConfigDedicated_present{false}, nonCriticalExtension_present{false} {};
public:
...
public:
    RRCConnectionSetup_v8a0_IEs* nonCriticalExtension_Set();
    int nonCriticalExtension_Set(RRCConnectionSetup_v8a0_IEs &value);
    const RRCConnectionSetup_v8a0_IEs& nonCriticalExtension_Get() const;
...
private:
    ...
    RRCConnectionSetup_v8a0_IEs nonCriticalExtension;
