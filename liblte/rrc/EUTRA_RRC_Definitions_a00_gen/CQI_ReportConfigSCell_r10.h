...
#ifndef __CQI_ReportConfigSCell_r10_H__
#define __CQI_ReportConfigSCell_r10_H__

#include <array>
#include <cstdint>
#include <vector>

class CQI_ReportConfigSCell_r10
{
public:
    CQI_ReportConfigSCell_r10() : cqi_ReportModeAperiodic_present{false}, nomPDSCH_RS_EPRE_Offset_present{false} {};
public:
