...
#ifndef __ULInformationTransfer_v8a0_IEs_H__
#define __ULInformationTransfer_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class ULInformationTransfer_v8a0_IEs
{
public:
    ULInformationTransfer_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
