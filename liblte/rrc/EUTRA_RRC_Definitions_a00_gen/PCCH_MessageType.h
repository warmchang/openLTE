...
#ifndef __PCCH_MessageType_H__
#define __PCCH_MessageType_H__
...
private:
    ...
    // paging
public:
    Paging* c1_paging_Set();
    int c1_paging_Set(Paging &value);
    const Paging& c1_paging_Get() const;
    std::string c1_paging_ToString(uint32_t indent) const;
    std::string c1_paging_ToStringNoNewLines() const;
    int c1_paging_Clear();
    bool c1_paging_IsPresent() const;
private:
    bool c1_paging_present;
    Paging c1_paging;
