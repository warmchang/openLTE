...
#ifndef __SecurityModeComplete_H__
#define __SecurityModeComplete_H__
...
{
public:
    SecurityModeComplete() : rrc_TransactionIdentifier_present{false}, criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_Enum {
        k_criticalExtensions_securityModeComplete_r8 = 0,
...
public:
    SecurityModeComplete_r8_IEs* criticalExtensions_securityModeComplete_r8_Set();
    int criticalExtensions_securityModeComplete_r8_Set(SecurityModeComplete_r8_IEs &value);
    const SecurityModeComplete_r8_IEs& criticalExtensions_securityModeComplete_r8_Get() const;
    std::string criticalExtensions_securityModeComplete_r8_ToString(uint32_t indent) const;
    std::string criticalExtensions_securityModeComplete_r8_ToStringNoNewLines() const;
    int criticalExtensions_securityModeComplete_r8_Clear();
    bool criticalExtensions_securityModeComplete_r8_IsPresent() const;
private:
    bool criticalExtensions_securityModeComplete_r8_present;
    SecurityModeComplete_r8_IEs criticalExtensions_securityModeComplete_r8;
