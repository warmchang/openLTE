...
#ifndef __RRCConnectionReconfigurationComplete_H__
#define __RRCConnectionReconfigurationComplete_H__
...
{
public:
    RRCConnectionReconfigurationComplete() : rrc_TransactionIdentifier_present{false}, criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_Enum {
        k_criticalExtensions_rrcConnectionReconfigurationComplete_r8 = 0,
...
public:
    RRCConnectionReconfigurationComplete_r8_IEs* criticalExtensions_rrcConnectionReconfigurationComplete_r8_Set();
    int criticalExtensions_rrcConnectionReconfigurationComplete_r8_Set(RRCConnectionReconfigurationComplete_r8_IEs &value);
    const RRCConnectionReconfigurationComplete_r8_IEs& criticalExtensions_rrcConnectionReconfigurationComplete_r8_Get() const;
    std::string criticalExtensions_rrcConnectionReconfigurationComplete_r8_ToString(uint32_t indent) const;
    std::string criticalExtensions_rrcConnectionReconfigurationComplete_r8_ToStringNoNewLines() const;
    int criticalExtensions_rrcConnectionReconfigurationComplete_r8_Clear();
    bool criticalExtensions_rrcConnectionReconfigurationComplete_r8_IsPresent() const;
private:
    bool criticalExtensions_rrcConnectionReconfigurationComplete_r8_present;
    RRCConnectionReconfigurationComplete_r8_IEs criticalExtensions_rrcConnectionReconfigurationComplete_r8;
