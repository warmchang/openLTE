...
#ifndef __HandoverCommand_H__
#define __HandoverCommand_H__
...
{
public:
    HandoverCommand() : criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_c1_Enum {
        k_criticalExtensions_c1_handoverCommand_r8 = 0,
...
private:
    ...
    // handoverCommand-r8
public:
    HandoverCommand_r8_IEs* criticalExtensions_c1_handoverCommand_r8_Set();
    int criticalExtensions_c1_handoverCommand_r8_Set(HandoverCommand_r8_IEs &value);
    const HandoverCommand_r8_IEs& criticalExtensions_c1_handoverCommand_r8_Get() const;
    std::string criticalExtensions_c1_handoverCommand_r8_ToString(uint32_t indent) const;
    std::string criticalExtensions_c1_handoverCommand_r8_ToStringNoNewLines() const;
    int criticalExtensions_c1_handoverCommand_r8_Clear();
    bool criticalExtensions_c1_handoverCommand_r8_IsPresent() const;
private:
    bool criticalExtensions_c1_handoverCommand_r8_present;
    HandoverCommand_r8_IEs criticalExtensions_c1_handoverCommand_r8;
