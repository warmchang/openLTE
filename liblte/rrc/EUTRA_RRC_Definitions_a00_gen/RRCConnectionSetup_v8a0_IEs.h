...
#ifndef __RRCConnectionSetup_v8a0_IEs_H__
#define __RRCConnectionSetup_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class RRCConnectionSetup_v8a0_IEs
{
public:
    RRCConnectionSetup_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
