...
#ifndef __FreqPriorityUTRA_FDD_H__
#define __FreqPriorityUTRA_FDD_H__
...
class FreqPriorityUTRA_FDD
{
public:
    FreqPriorityUTRA_FDD() : carrierFreq_present{false}, cellReselectionPriority_present{false} {};
public:
