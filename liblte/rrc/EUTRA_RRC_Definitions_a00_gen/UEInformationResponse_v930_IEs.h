...
#ifndef __UEInformationResponse_v930_IEs_H__
#define __UEInformationResponse_v930_IEs_H__
...
class UEInformationResponse_v930_IEs
{
public:
    UEInformationResponse_v930_IEs() : lateNonCriticalExtension_present{false}, nonCriticalExtension_present{false} {};
public:
...
public:
    UEInformationResponse_v10xy_IEs* nonCriticalExtension_Set();
    int nonCriticalExtension_Set(UEInformationResponse_v10xy_IEs &value);
    const UEInformationResponse_v10xy_IEs& nonCriticalExtension_Get() const;
...
private:
    ...
    UEInformationResponse_v10xy_IEs nonCriticalExtension;
