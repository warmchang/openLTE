...
#ifndef __RRCConnectionReject_v8a0_IEs_H__
#define __RRCConnectionReject_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class RRCConnectionReject_v8a0_IEs
{
public:
    RRCConnectionReject_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
