...
#ifndef __UECapabilityInformation_v8a0_IEs_H__
#define __UECapabilityInformation_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class UECapabilityInformation_v8a0_IEs
{
public:
    UECapabilityInformation_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
