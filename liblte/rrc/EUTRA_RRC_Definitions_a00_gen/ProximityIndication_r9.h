...
#ifndef __ProximityIndication_r9_H__
#define __ProximityIndication_r9_H__
...
class ProximityIndication_r9
{
public:
    ProximityIndication_r9() : criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_c1_Enum {
        k_criticalExtensions_c1_proximityIndication_r9 = 0,
...
public:
    ProximityIndication_r9_IEs* criticalExtensions_c1_proximityIndication_r9_Set();
    int criticalExtensions_c1_proximityIndication_r9_Set(ProximityIndication_r9_IEs &value);
    const ProximityIndication_r9_IEs& criticalExtensions_c1_proximityIndication_r9_Get() const;
    std::string criticalExtensions_c1_proximityIndication_r9_ToString(uint32_t indent) const;
    std::string criticalExtensions_c1_proximityIndication_r9_ToStringNoNewLines() const;
    int criticalExtensions_c1_proximityIndication_r9_Clear();
    bool criticalExtensions_c1_proximityIndication_r9_IsPresent() const;
private:
    bool criticalExtensions_c1_proximityIndication_r9_present;
    ProximityIndication_r9_IEs criticalExtensions_c1_proximityIndication_r9;
