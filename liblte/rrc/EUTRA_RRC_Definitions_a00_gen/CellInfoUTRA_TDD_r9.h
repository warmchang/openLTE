...
#ifndef __CellInfoUTRA_TDD_r9_H__
#define __CellInfoUTRA_TDD_r9_H__
...
class CellInfoUTRA_TDD_r9
{
public:
    CellInfoUTRA_TDD_r9() : physCellId_r9_present{false}, utra_BCCH_Container_r9_present{false} {};
public:
    ...
    // physCellId-r9
public:
    PhysCellIdUTRA_TDD* physCellId_r9_Set();
    int physCellId_r9_Set(PhysCellIdUTRA_TDD &value);
    const PhysCellIdUTRA_TDD& physCellId_r9_Get() const;
