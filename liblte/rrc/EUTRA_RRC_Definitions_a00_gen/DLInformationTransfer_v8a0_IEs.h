...
#ifndef __DLInformationTransfer_v8a0_IEs_H__
#define __DLInformationTransfer_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class DLInformationTransfer_v8a0_IEs
{
public:
    DLInformationTransfer_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
