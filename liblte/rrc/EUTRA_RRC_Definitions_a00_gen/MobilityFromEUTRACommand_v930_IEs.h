...
#ifndef __MobilityFromEUTRACommand_v930_IEs_H__
#define __MobilityFromEUTRACommand_v930_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class MobilityFromEUTRACommand_v930_IEs
{
public:
    MobilityFromEUTRACommand_v930_IEs() : lateNonCriticalExtension_present{false} {};
public:
