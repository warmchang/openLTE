...
#ifndef __RRCConnectionReestablishmentComplete_v8a0_IEs_H__
#define __RRCConnectionReestablishmentComplete_v8a0_IEs_H__
...
class RRCConnectionReestablishmentComplete_v8a0_IEs
{
public:
    RRCConnectionReestablishmentComplete_v8a0_IEs() : lateNonCriticalExtension_present{false}, nonCriticalExtension_present{false} {};
public:
...
public:
    RRCConnectionReestablishmentComplete_v10xy_IEs* nonCriticalExtension_Set();
    int nonCriticalExtension_Set(RRCConnectionReestablishmentComplete_v10xy_IEs &value);
    const RRCConnectionReestablishmentComplete_v10xy_IEs& nonCriticalExtension_Get() const;
...
private:
    ...
    RRCConnectionReestablishmentComplete_v10xy_IEs nonCriticalExtension;
