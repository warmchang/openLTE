...
#ifndef __RRCConnectionReestablishmentComplete_v10xy_IEs_H__
#define __RRCConnectionReestablishmentComplete_v10xy_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class RRCConnectionReestablishmentComplete_v10xy_IEs
{
public:
    RRCConnectionReestablishmentComplete_v10xy_IEs() : logMeasAvailable_r10_present{false} {};
public:
