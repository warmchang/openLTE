...
#ifndef __CounterCheck_H__
#define __CounterCheck_H__
...
{
public:
    CounterCheck() : rrc_TransactionIdentifier_present{false}, criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_c1_Enum {
        k_criticalExtensions_c1_counterCheck_r8 = 0,
...
private:
    ...
    // counterCheck-r8
public:
    CounterCheck_r8_IEs* criticalExtensions_c1_counterCheck_r8_Set();
    int criticalExtensions_c1_counterCheck_r8_Set(CounterCheck_r8_IEs &value);
    const CounterCheck_r8_IEs& criticalExtensions_c1_counterCheck_r8_Get() const;
    std::string criticalExtensions_c1_counterCheck_r8_ToString(uint32_t indent) const;
    std::string criticalExtensions_c1_counterCheck_r8_ToStringNoNewLines() const;
    int criticalExtensions_c1_counterCheck_r8_Clear();
    bool criticalExtensions_c1_counterCheck_r8_IsPresent() const;
private:
    bool criticalExtensions_c1_counterCheck_r8_present;
    CounterCheck_r8_IEs criticalExtensions_c1_counterCheck_r8;
