...
#ifndef __SecurityModeFailure_H__
#define __SecurityModeFailure_H__
...
class SecurityModeFailure
{
public:
    SecurityModeFailure() : rrc_TransactionIdentifier_present{false}, criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_Enum {
        k_criticalExtensions_securityModeFailure_r8 = 0,
...
public:
    SecurityModeFailure_r8_IEs* criticalExtensions_securityModeFailure_r8_Set();
    int criticalExtensions_securityModeFailure_r8_Set(SecurityModeFailure_r8_IEs &value);
    const SecurityModeFailure_r8_IEs& criticalExtensions_securityModeFailure_r8_Get() const;
    std::string criticalExtensions_securityModeFailure_r8_ToString(uint32_t indent) const;
    std::string criticalExtensions_securityModeFailure_r8_ToStringNoNewLines() const;
    int criticalExtensions_securityModeFailure_r8_Clear();
    bool criticalExtensions_securityModeFailure_r8_IsPresent() const;
private:
    bool criticalExtensions_securityModeFailure_r8_present;
    SecurityModeFailure_r8_IEs criticalExtensions_securityModeFailure_r8;
