...
#ifndef __UERadioAccessCapabilityInformation_H__
#define __UERadioAccessCapabilityInformation_H__
...
class UERadioAccessCapabilityInformation
{
public:
    UERadioAccessCapabilityInformation() : criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_c1_Enum {
        k_criticalExtensions_c1_ueRadioAccessCapabilityInformation_r8 = 0,
...
public:
    UERadioAccessCapabilityInformation_r8_IEs* criticalExtensions_c1_ueRadioAccessCapabilityInformation_r8_Set();
    int criticalExtensions_c1_ueRadioAccessCapabilityInformation_r8_Set(UERadioAccessCapabilityInformation_r8_IEs &value);
    const UERadioAccessCapabilityInformation_r8_IEs& criticalExtensions_c1_ueRadioAccessCapabilityInformation_r8_Get() const;
    std::string criticalExtensions_c1_ueRadioAccessCapabilityInformation_r8_ToString(uint32_t indent) const;
    std::string criticalExtensions_c1_ueRadioAccessCapabilityInformation_r8_ToStringNoNewLines() const;
    int criticalExtensions_c1_ueRadioAccessCapabilityInformation_r8_Clear();
    bool criticalExtensions_c1_ueRadioAccessCapabilityInformation_r8_IsPresent() const;
private:
    bool criticalExtensions_c1_ueRadioAccessCapabilityInformation_r8_present;
    UERadioAccessCapabilityInformation_r8_IEs criticalExtensions_c1_ueRadioAccessCapabilityInformation_r8;
