...
#ifndef __RNReconfigurationComplete_r10_IEs_H__
#define __RNReconfigurationComplete_r10_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class RNReconfigurationComplete_r10_IEs
{
public:
    RNReconfigurationComplete_r10_IEs() : lateNonCriticalExtension_present{false} {};
public:
