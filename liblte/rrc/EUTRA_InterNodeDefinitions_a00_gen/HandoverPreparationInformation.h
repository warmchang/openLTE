...
#ifndef __HandoverPreparationInformation_H__
#define __HandoverPreparationInformation_H__
...
class HandoverPreparationInformation
{
public:
    HandoverPreparationInformation() : criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_c1_Enum {
        k_criticalExtensions_c1_handoverPreparationInformation_r8 = 0,
...
public:
    HandoverPreparationInformation_r8_IEs* criticalExtensions_c1_handoverPreparationInformation_r8_Set();
    int criticalExtensions_c1_handoverPreparationInformation_r8_Set(HandoverPreparationInformation_r8_IEs &value);
    const HandoverPreparationInformation_r8_IEs& criticalExtensions_c1_handoverPreparationInformation_r8_Get() const;
    std::string criticalExtensions_c1_handoverPreparationInformation_r8_ToString(uint32_t indent) const;
    std::string criticalExtensions_c1_handoverPreparationInformation_r8_ToStringNoNewLines() const;
    int criticalExtensions_c1_handoverPreparationInformation_r8_Clear();
    bool criticalExtensions_c1_handoverPreparationInformation_r8_IsPresent() const;
private:
    bool criticalExtensions_c1_handoverPreparationInformation_r8_present;
    HandoverPreparationInformation_r8_IEs criticalExtensions_c1_handoverPreparationInformation_r8;
