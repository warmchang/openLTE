...
#ifndef __ULHandoverPreparationTransfer_v8a0_IEs_H__
#define __ULHandoverPreparationTransfer_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class ULHandoverPreparationTransfer_v8a0_IEs
{
public:
    ULHandoverPreparationTransfer_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
