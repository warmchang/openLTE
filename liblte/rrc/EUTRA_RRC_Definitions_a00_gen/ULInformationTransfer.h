...
#ifndef __ULInformationTransfer_H__
#define __ULInformationTransfer_H__
...
class ULInformationTransfer
{
public:
    ULInformationTransfer() : criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_c1_Enum {
        k_criticalExtensions_c1_ulInformationTransfer_r8 = 0,
...
public:
    ULInformationTransfer_r8_IEs* criticalExtensions_c1_ulInformationTransfer_r8_Set();
    int criticalExtensions_c1_ulInformationTransfer_r8_Set(ULInformationTransfer_r8_IEs &value);
    const ULInformationTransfer_r8_IEs& criticalExtensions_c1_ulInformationTransfer_r8_Get() const;
    std::string criticalExtensions_c1_ulInformationTransfer_r8_ToString(uint32_t indent) const;
    std::string criticalExtensions_c1_ulInformationTransfer_r8_ToStringNoNewLines() const;
    int criticalExtensions_c1_ulInformationTransfer_r8_Clear();
    bool criticalExtensions_c1_ulInformationTransfer_r8_IsPresent() const;
private:
    bool criticalExtensions_c1_ulInformationTransfer_r8_present;
    ULInformationTransfer_r8_IEs criticalExtensions_c1_ulInformationTransfer_r8;
