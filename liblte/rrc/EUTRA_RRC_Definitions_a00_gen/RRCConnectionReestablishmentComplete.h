...
#ifndef __RRCConnectionReestablishmentComplete_H__
#define __RRCConnectionReestablishmentComplete_H__
...
class RRCConnectionReestablishmentComplete
{
public:
    RRCConnectionReestablishmentComplete() : rrc_TransactionIdentifier_present{false}, criticalExtensions_present{false} {};
public:
...
public:
    enum criticalExtensions_Enum {
        k_criticalExtensions_rrcConnectionReestablishmentComplete_r8 = 0,
...
public:
    RRCConnectionReestablishmentComplete_r8_IEs* criticalExtensions_rrcConnectionReestablishmentComplete_r8_Set();
    int criticalExtensions_rrcConnectionReestablishmentComplete_r8_Set(RRCConnectionReestablishmentComplete_r8_IEs &value);
    const RRCConnectionReestablishmentComplete_r8_IEs& criticalExtensions_rrcConnectionReestablishmentComplete_r8_Get() const;
    std::string criticalExtensions_rrcConnectionReestablishmentComplete_r8_ToString(uint32_t indent) const;
    std::string criticalExtensions_rrcConnectionReestablishmentComplete_r8_ToStringNoNewLines() const;
    int criticalExtensions_rrcConnectionReestablishmentComplete_r8_Clear();
    bool criticalExtensions_rrcConnectionReestablishmentComplete_r8_IsPresent() const;
private:
    bool criticalExtensions_rrcConnectionReestablishmentComplete_r8_present;
    RRCConnectionReestablishmentComplete_r8_IEs criticalExtensions_rrcConnectionReestablishmentComplete_r8;
