...
#ifndef __SystemInformation_v8a0_IEs_H__
#define __SystemInformation_v8a0_IEs_H__

#include <array>
#include <cstdint>
#include <vector>

class SystemInformation_v8a0_IEs
{
public:
    SystemInformation_v8a0_IEs() : lateNonCriticalExtension_present{false} {};
public:
