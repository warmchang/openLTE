...
#ifndef __MobilityFromEUTRACommand_r8_IEs_H__
#define __MobilityFromEUTRACommand_r8_IEs_H__
...
class MobilityFromEUTRACommand_r8_IEs
{
public:
    MobilityFromEUTRACommand_r8_IEs() : cs_FallbackIndicator_present{false}, purpose_present{false}, nonCriticalExtension_present{false} {};
public:
...
public:
    MobilityFromEUTRACommand_v8a0_IEs* nonCriticalExtension_Set();
    int nonCriticalExtension_Set(MobilityFromEUTRACommand_v8a0_IEs &value);
    const MobilityFromEUTRACommand_v8a0_IEs& nonCriticalExtension_Get() const;
...
private:
    ...
    MobilityFromEUTRACommand_v8a0_IEs nonCriticalExtension;
